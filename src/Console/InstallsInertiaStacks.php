...
trait InstallsInertiaStacks
{
	...
	protected function installInertiaVueStack()
	{
		...
		(new Filesystem())->copyDirectory(
			__DIR__ . "/../../stubs/inertia-common/app/Http/Controllers",
		...
		// Views...
		copy(
			__DIR__ . "/../../stubs/inertia-vue/resources/views/app.blade.php",
		...
		if ($this->option("typescript")) {
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-vue-ts/resources/js/Components",
				resource_path("js/Components")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-vue-ts/resources/js/Layouts",
				resource_path("js/Layouts")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-vue-ts/resources/js/Pages",
				resource_path("js/Pages")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-vue-ts/resources/js/types",
				resource_path("js/types")
			);
		} else {
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-vue/resources/js/Components",
				resource_path("js/Components")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-vue/resources/js/Layouts",
				resource_path("js/Layouts")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-vue/resources/js/Pages",
				resource_path("js/Pages")
			);
		}
		...
		if ($this->option("pest")) {
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-common/pest-tests/Feature",
				base_path("tests/Feature")
			);
		} else {
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-common/tests/Feature",
				base_path("tests/Feature")
			);
		}
		...
		// Routes...
		copy(
			__DIR__ . "/../../stubs/inertia-common/routes/web.php",
			base_path("routes/web.php")
		);
		copy(
			__DIR__ . "/../../stubs/inertia-common/routes/auth.php",
		...
		// Tailwind / Vite...
		copy(
			__DIR__ . "/../../stubs/default/resources/css/app.css",
			resource_path("css/app.css")
		);
		copy(
			__DIR__ . "/../../stubs/default/postcss.config.js",
			base_path("postcss.config.js")
		);
		copy(
			__DIR__ . "/../../stubs/inertia-common/tailwind.config.js",
			base_path("tailwind.config.js")
		);
		copy(
			__DIR__ . "/../../stubs/inertia-vue/vite.config.js",
	...
	protected function installInertiaVueSsrStack()
	{
		...
		$this->replaceInFile(
			"/node_modules",
			"/bootstrap/ssr" . PHP_EOL . "/node_modules",
			base_path(".gitignore")
		);
	}
	...
	protected function installInertiaReactStack()
	{
		...
		if ($this->option("typescript")) {
			(new Filesystem())->copyDirectory(
				__DIR__ .
					"/../../stubs/inertia-react-ts/resources/js/Components",
				resource_path("js/Components")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-react-ts/resources/js/Layouts",
				resource_path("js/Layouts")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-react-ts/resources/js/Pages",
				resource_path("js/Pages")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-react-ts/resources/js/types",
				resource_path("js/types")
			);
		} else {
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-react/resources/js/Components",
				resource_path("js/Components")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-react/resources/js/Layouts",
				resource_path("js/Layouts")
			);
			(new Filesystem())->copyDirectory(
				__DIR__ . "/../../stubs/inertia-react/resources/js/Pages",
				resource_path("js/Pages")
			);
		}
		...
		copy(
			__DIR__ . "/../../stubs/inertia-react/vite.config.js",
			base_path("vite.config.js")
		);
		...
		if ($this->option("typescript")) {
			...
			copy(
				__DIR__ . "/../../stubs/inertia-react-ts/resources/js/app.tsx",
			...
			copy(
				__DIR__ . "/../../stubs/inertia-react/resources/js/app.jsx",
