...
trait InstallsApiStack
{
	...
	protected function installApiStack()
	{
		...
		$files->copyDirectory(
			__DIR__ . "/../../stubs/api/app/Http/Controllers/Auth",
			app_path("Http/Controllers/Auth")
		);

		// Middleware...
		$files->copyDirectory(
			__DIR__ . "/../../stubs/api/app/Http/Middleware",
		...
		$files->copyDirectory(
			__DIR__ . "/../../stubs/api/app/Http/Requests/Auth",
			app_path("Http/Requests/Auth")
		);

		// Providers...
		$files->copyDirectory(
			__DIR__ . "/../../stubs/api/app/Providers",
			app_path("Providers")
		);
		$this->replaceInFile(
			"HOME = '/home'",
