...
trait InstallsBladeStack
{
	...
	protected function installBladeStack()
	{
		...
		// Routes...
		copy(
			__DIR__ . "/../../stubs/default/routes/web.php",
			base_path("routes/web.php")
		);
		copy(
			__DIR__ . "/../../stubs/default/routes/auth.php",
		...
		// Tailwind / Vite...
		copy(
			__DIR__ . "/../../stubs/default/tailwind.config.js",
		...
		copy(
			__DIR__ . "/../../stubs/default/resources/js/app.js",
